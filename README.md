...
- **Smart Date Selection** – Preset ranges (This Week, This Month, Last Month, etc.) or custom dates
- **Automatic Scrolling** – Intelligently handles infinite scroll and lazy-loaded content
- **Progress Tracking** – Real-time notifications show export progress
- **CSV Format** – RFC 4180 compliant, works perfectly with Excel, Google Sheets, and data analysis tools
- **Transaction Deduplication** – Automatically handles duplicate transactions
