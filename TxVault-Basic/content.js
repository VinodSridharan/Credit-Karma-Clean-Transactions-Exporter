// ============================================================================
// Credit Karma Transaction Extractor - Basic Version
// Enhanced with late November 2024 date format fix for DOM date changes
// Original by Chirag Bangera (https://github.com/cbangera2/CreditKarmaExtractor)
// ============================================================================
...
function convertDateFormat(inputDate) {
    ...
    if (typeof inputDate === 'string') {
        if (inputDate.includes('/')) {
            ...
            // Month DD, YYYY format (e.g., "January 15, 2023" or "Nov 20, 2025")
            // This handles both long month names (January) and short month names (Nov)
    ...
    if (request.action === 'captureTransactions') {
        try {
            ...
            captureTransactionsInDateRange(startDate, endDate).then(({ allTransactions, filteredTransactions }) => {
                ...
                completionNotice.style.left = '20px';
